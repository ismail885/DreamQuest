...
export const ACHIEVEMENTS_CONFIG: Array<{
  ...
  { id: 'ten_stories', title: 'Veteran', description: 'Terminez 10 aventures', icon: 'Award', condition: (stats) => stats.storiesPlayed >= 10 },
  ...
  { id: 'popular_creator', title: 'Auteur Populaire', description: 'Attaignez 10 votes sur vos aventures', icon: 'Star', condition: (stats) => stats.totalLikes >= 10 },
  ...
  // DIVERS
  { id: 'night_owl', title: 'Noctambule', description: 'Jouez pendant la nuit', icon: 'Moon', condition: () => true },
  { id: 'explorer', title: 'Explorateur', description: 'Jouez à tous les types d\'aventures', icon: 'Compass', condition: () => true },
];
