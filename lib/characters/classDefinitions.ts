...
export const CHARACTER_CLASSES: Record<CharacterClass, ClassInfo> = {
  ...
  Archer: {
    ...
    image: '/illustrations_personnage/archer.jpg',
  ...
  Druide: {
    ...
    image: '/illustrations_personnage/druide.jpg',
    role: 'Hybride',
  ...
  Voleur: {
    ...
    image: '/illustrations_personnage/voleur.jpg',
    role: 'Assassin',
    playstyle: 'Furtivité et Critique',
    difficulty: 'INTERMEDIAIRE',
    difficultyOrder: 2,
  ...
  Barbare: {
    ...
    image: '/illustrations_personnage/barbare.jpg',
    role: 'Berserker',
