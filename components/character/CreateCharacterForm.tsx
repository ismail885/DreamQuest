            ...
            <div className="relative flex-shrink-0">
              ...
              <div className="flex items-center justify-center gap-4 mt-3">
                <button
                  ...
                  className="w-10 h-10 rounded-full bg-[#1a2332]/90 hover:bg-cyan-600/50 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all border border-gray-700/50 hover:border-cyan-500/50"
