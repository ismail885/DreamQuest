...
export default function RegisterForm() {
  ...
  const { register, loginWithGoogle, loginWithDiscord } = useAuthContext();
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              onClick={async () => {
                ...
                if (!result.success) setError(result.error || "Erreur avec Google");
                setIsLoading(false);
              }}
              disabled={isLoading}
            ...
            <button
              ...
              onClick={async () => {
                ...
                if (!result.success) setError(result.error || "Erreur avec Discord");
                setIsLoading(false);
              }}
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-transparent border border-cyan-500/20 hover:border-cyan-500/40 rounded-card text-gray-300 hover:text-white transition-all text-sm font-medium disabled:opacity-50"
            ...
            <div className="relative py-2">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 backdrop-blur-card bg-slate-900/60 text-gray-500">ou</span>
              </div>
            </div>
          </div>
