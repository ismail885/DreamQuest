          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#1a1f2e] border border-gray-700 hover:border-gray-600 rounded-lg text-gray-300 hover:text-content-primary transition-all text-sm font-medium disabled:opacity-50"
              >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 disabled:from-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed text-content-primary font-semibold rounded-lg transition-all duration-200 text-sm shadow-lg shadow-cyan-500/20 flex items-center justify-center gap-2"
            >
              {isLoading && (
