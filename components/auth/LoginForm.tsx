...
export default function LoginForm() {
 ...
 type="button"
 disabled
 className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-transparent border border-gray-700/50 rounded-lg text-gray-600 cursor-not-allowed text-sm font-medium opacity-60"
 ...
 <span className="text-xs text-gray-600 ml-1">(Bientôt)</span>
 </button>
 </div>
