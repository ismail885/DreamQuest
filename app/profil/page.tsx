...
export default function ProfilPage() {
 ...
 <div className="bg-[#0c1322] border border-gray-700/50 rounded-xl lg:rounded-2xl p-4 md:p-6">
 ...
 className="w-full py-3 px-4 bg-[#141d2e] border border-gray-600/50 rounded-lg text-white font-medium hover:bg-[#141d2e] transition-colors flex items-center justify-center gap-2"
 >
 ...
 <div className="relative bg-[#0c1322] border border-gray-700/50 rounded-t-2xl md:rounded-2xl p-6 w-full max-w-md mx-4 shadow-2xl shadow-cyan-500/10 max-h-[85vh] overflow-y-auto md:max-h-none">
 ...
 <div className="space-y-4">
 <div className="flex items-center justify-between p-4 bg-[#141d2e] rounded-lg">
 ...
 <div className="p-4 bg-[#141d2e] rounded-lg">
 ...
 className="w-full px-4 py-2 bg-[#0c1322] border border-content-secondary/30 rounded-lg text-white focus:outline-none focus:border-primary transition-colors"
 >
 ...
 <button
 onClick={closeSettingsModal}
 className="flex-1 py-3 px-4 bg-[#141d2e] border border-gray-600/50 rounded-lg text-white font-medium hover:bg-[#141d2e] hover:text-white transition-colors"
 >
 Annuler
 </button>
 <button
 ...
 className="w-full px-4 py-3 bg-[#141d2e] border border-gray-600/50 rounded-lg text-white placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
