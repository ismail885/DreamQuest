...
export default function Home() {
 ...
 <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-cyan-500/15 border border-cyan-300/40 rounded-full text-cyan-300 text-sm font-medium backdrop-blur-sm">
 <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
 <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
 </svg>
 RPG Textuel Interactif ⚔️
 </div>
 ...
 <div className="group p-6 md:p-8 bg-[#0c1322]/50 border border-cyan-500/20 rounded-xl hover:border-cyan-400/50 hover:shadow-lg hover:shadow-cyan-500/10 transition-all duration-300">
 ...
 <svg className="w-6 h-6 text-cyan-400 group-hover:text-cyan-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
