          ...
          <div className="text-center space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
              <Link
                ...
                prefetch
                className="px-8 py-3.5 bg-cyan-500 hover:bg-cyan-400 text-white font-semibold rounded-lg transition-all duration-200 w-full sm:w-auto text-center"
              >
                Créer un Personnage
              </Link>
              ...
              <Link
                href="/adventure"
                prefetch
                className="px-8 py-3.5 bg-transparent border border-gray-600 hover:border-gray-500 text-gray-300 hover:text-white font-semibold rounded-lg transition-all duration-200 w-full sm:w-auto text-center"
              >
                Explorer les Quêtes
              </Link>
            </div>
