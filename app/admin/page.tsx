    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-white dark:text-gray-900 mb-2">Erreur de connexion</h2>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white dark:text-gray-900">Dashboard Administrateur</h1>
          <p className="text-gray-400 dark:text-gray-500 mt-2">Vue d&apos;ensemble de votre application</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        {statCards.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-[#0f1623] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-xl p-6 hover:border-gray-700 dark:hover:border-gray-300 transition-all"
            >
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-gray-400 dark:text-gray-500 text-sm">{stat.title}</p>
                  <p className="text-3xl font-bold text-white dark:text-gray-900 mt-2">{stat.value.toLocaleString()}</p>
                  <p className="text-gray-500 dark:text-gray-600 text-xs mt-2">{stat.subtitle}</p>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Role Distribution */}
        <div className="bg-[#0f1623] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-xl p-6">
          <h2 className="text-xl font-bold text-white dark:text-gray-900 mb-6">Distribution des rôles</h2>
              ...
              return (
                <div key={index}>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-400 dark:text-gray-500 text-sm">{item.role}</span>
                    <span className="text-white dark:text-gray-900 font-medium">{item.count}</span>
                  </div>
        ...
        {/* Quick Actions */}
        <div className="bg-[#0f1623] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-xl p-6">
          <h2 className="text-xl font-bold text-white dark:text-gray-900 mb-6">Actions rapides</h2>
          <div className="grid grid-cols-2 gap-4">
            <a
              href="/admin/users"
              className="p-4 bg-gray-800/50 dark:bg-gray-200/50 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-all text-center"
            >
              <Users className="w-8 h-8 text-cyan-400 mx-auto mb-2" />
              <span className="text-gray-400 dark:text-gray-500 text-sm">Gérer utilisateurs</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-gray-400 dark:text-gray-500 text-sm">Gérer aventures</span>
            </a>
            <a
            ...
            >
              ...
              <span className="text-gray-400 dark:text-gray-500 text-sm">Gérer personnages</span>
            </a>
            <a
              href="/dashboard"
              className="p-4 bg-gray-800/50 dark:bg-gray-200/50 rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-all text-center"
            >
              ...
              <span className="text-gray-400 dark:text-gray-500 text-sm">Voir le site</span>
            </a>
          </div>
        </div>
      </div>
      ...
      {/* System Info */}
      <div className="bg-[#0f1623] dark:bg-white border border-gray-800 dark:border-gray-200 rounded-xl p-6">
        <h2 className="text-xl font-bold text-white dark:text-gray-900 mb-4">Informations système</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-400 dark:text-gray-500 text-sm">Statut</p>
              <p className="text-white dark:text-gray-900 font-medium">Opérationnel</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-gray-400 dark:text-gray-500 text-sm">Dernière mise à jour</p>
              <p className="text-white dark:text-gray-900 font-medium">{new Date().toLocaleDateString("fr-FR")}</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white dark:text-gray-900 font-medium">DreamQuest v0.1.0</p>
            </div>
          </div>
        </div>
      </div>
