...
export default function ForgotPasswordPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 bg-[#0a0e1a] dark:bg-gray-50 text-white dark:text-gray-900">
      ...
      <section className="w-full max-w-md relative z-10 rounded-2xl border border-gray-800/60 dark:border-gray-200/60 bg-[#0f1623]/80 dark:bg-white/80 p-8 backdrop-blur-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label htmlFor="email" className="mb-2 block text-sm text-gray-400 dark:text-gray-500">
              Email
            </label>
            <input
              id="email"
              ...
              required
              className="w-full rounded-lg border border-gray-700 dark:border-gray-300 bg-[#1a1f2e] dark:bg-gray-200 px-4 py-3 text-sm text-white dark:text-gray-900 outline-none transition focus:border-cyan-500"
        ...
        <div className="mt-5 text-center text-sm text-gray-400 dark:text-gray-500">
